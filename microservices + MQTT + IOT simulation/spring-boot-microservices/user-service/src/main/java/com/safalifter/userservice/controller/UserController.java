...
import com.safalifter.userservice.request.UpdateUserRoleRequest; // Import the new request DTO
...
public class UserController {
    ...
    public ResponseEntity<UserDto> updateUserRole(@Valid @RequestBody UpdateUserRoleRequest request) {
        return ResponseEntity.ok(modelMapper.map(userService.updateUserRole(request), UserDto.class));
    }
}